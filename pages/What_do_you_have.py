...
match ss.idx:
    ...
    case 0:
        """
        # Lets find an EV for you

        Enter what car you have right now, and we'll try to find a EV similar to it

        If you already have an EV in mind, you can go here: [What do you want?](What_do_you_want)
